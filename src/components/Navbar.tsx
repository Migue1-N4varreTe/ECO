      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            {/* Desktop navigation */}
            <div className="hidden md:ml-5 md:flex md:space-x-5">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
          ...
          {/* Search bar */}
          <div className="hidden sm:flex items-center flex-1 max-w-lg mx-5">
              ...
              <div className="flex items-center gap-1">
                <Link to="/login">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="px-2.5 font-sans text-xl"
                  >
                    Iniciar Sesión
                  </Button>
                </Link>
                <Link to="/register">
                  <Button
                    size="sm"
                    className="bg-green-600 hover:bg-green-700 font-sans text-xl"
                  >
                    <span className="font-sans text-white">Registrarse</span>
                  </Button>
                </Link>
              </div>
            )}
